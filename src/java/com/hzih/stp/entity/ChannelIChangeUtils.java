...
public class ChannelIChangeUtils {
    ...
    public int getBackupdirdelete() {
        return backupdirdelete;
    }

    public void setBackupdirdelete(int backupdirdelete) {
        this.backupdirdelete = backupdirdelete;
    }
}

...
public class GenAESKey {
    private static final Logger logger = Logger.getLogger(GenAESKey.class);
    public static final String AES = "AES";
    public static final String keyPath_1 = System.getProperty("ichange.home")+"/security/aes/aes_1.dat";
    public static final String keyPath_2 = System.getProperty("ichange.home")+"/security/aes/aes_2.dat";
    public static final String keyPath_3 = System.getProperty("ichange.home")+"/security/aes/aes_3.dat";
    public static final String keyPath_4 = System.getProperty("ichange.home")+"/security/aes/aes_4.dat";
    public static final String keyPath_5 = System.getProperty("ichange.home")+"/security/aes/aes_5.dat";
    ...
    public static byte[] toByteArray(InputStream input) {
        ...
        try {
            ...
            logger.error("AES stream to byte[] error!",e);
        }

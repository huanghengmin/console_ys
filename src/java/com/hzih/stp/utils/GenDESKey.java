...
public class GenDESKey {
    private static final Logger logger = Logger.getLogger(GenDESKey.class);
    public static final String DES = "DES";
	public static final String SKEY_NAME = "key.des";
    public static final String keyPath_1 = System.getProperty("ichange.home")+"/security/des/des_1.dat";
    public static final String keyPath_2 = System.getProperty("ichange.home")+"/security/des/des_2.dat";
    public static final String keyPath_3 = System.getProperty("ichange.home")+"/security/des/des_3.dat";
    public static final String keyPath_4 = System.getProperty("ichange.home")+"/security/des/des_4.dat";
    public static final String keyPath_5 = System.getProperty("ichange.home")+"/security/des/des_5.dat";
...
//			e.printStackTrace();
    ...
    public static CipherInputStream encryptDES(String keyPath,InputStream in) {
        ...
        try {
            ...
            logger.error("DES密钥文件找不到",e);
        } catch (Exception e) {
            logger.error("DES读取加密密钥错误",e);
        }
        //用key产生Cipher
        Cipher cipher = null;
        try {
    ...
    public static byte[] toByteArray(InputStream input) {
        ...
        try {
            ...
            logger.error("DES stream to byte[] error!",e);
        }

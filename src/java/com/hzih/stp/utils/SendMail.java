...
public class SendMail {
    public static final Logger logger = Logger.getLogger(SendMail.class);
...
//            System.out.println("Session.getInstance faild!"+e);
            logger.error("Session.getInstance faild!",e);
            return false;
        }
...
//            System.out.println("MimeMessage fiald! "+e.toString());
            logger.error("MimeMessage fiald! ",e);
            return false;
        }
    }
    /**
...
//            System.out.println("set Title faild!");
            logger.error("set Title faild!",e);
            return false;
        }
    }
    /**
...
//            System.out.println("Set context Faild! "+e);
            logger.error("Set context Faild! ",e);
            return false;
        }
    }
    /**
...
//            System.out.println("Send Mail 成功..");
            logger.info("Send Mail 成功..");
            tp.close();
            return true;
        }catch(Exception e){
            logger.error("Send Mail 失败",e);
            return false;
        }
    }

...
import com.hzih.stp.utils.filter.KeyWordsFilter;
...
public class KeywordsFilterFactory {
    ...
    public static Object newObjectByClass(String classname, Class cls) throws Ex {
        ...
        try {
            ...
            throw new com.inetec.common.exception.Ex().set(E.E_Unknown, new Message("Class not found:{0} ", Ex.getMessage()));
        }
        // Make sure c implements the required interfaces:
        if (!cls.isAssignableFrom(c)) {
            throw new Ex().set( new Message("The  class  does not implement the required interface {0}", cls.getName()));
        }
        ...
        try {
            ...
            throw new com.inetec.common.exception.Ex().set(new Message("Failed to instantiate class: ", Ex.getMessage()));
        } catch (IllegalAccessException Ex) {
            throw new com.inetec.common.exception.Ex().set(new Message("Failed to instantiate class; access exception: ", Ex.getMessage()));
        }
        return fr;
    }

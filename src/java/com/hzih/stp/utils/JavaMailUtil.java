...
//		Transport.send(message);
	...
	public static void main(String args[]) {
		...
		String email = "57184420@qq.com"; // 邮件发送人的邮件地址
		String account = "57184420@126.com"; // 发件人的邮件帐户
		String password = "jidyvrn57184420"; // 发件人的邮件密码
		String contact = "13867168447@126.com";

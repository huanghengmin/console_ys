...
public class StringContext {
    ...
    public static final String hotConfig = systemPath + "/data/backup/hotconfig.xml";

    public static final int GB = 1024*1024*1024;
    public static final int MB = 1024*1024;

    public static final String backPath = systemPath+"/data";
    public static String TempFileType = ".tmp";
    public static String ZipFileType = ".zip";
    public static String tables_xml = systemPath +"/data/tables/tables.xml";
    public static String filed_xml = systemPath +"/data/interface/filed.xml";
}

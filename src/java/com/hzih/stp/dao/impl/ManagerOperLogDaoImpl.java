...
import com.hzih.stp.dao.ManagerOperLogDao;
...
public class ManagerOperLogDaoImpl extends MyDaoSupport implements ManagerOperLogDao {

	@Override
	public void setEntityClass() {
		this.entityClass = ManagerOperLog.class;
	}
	...
	public PageResult listLogsByParams(int pageIndex, int pageLength,
		...
		StringBuffer sb = new StringBuffer(" from ManagerOperLog s where 1=1");

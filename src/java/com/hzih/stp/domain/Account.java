...
public class Account {
    ...
    Set<InterfaceObj> interfaceObjSet;
    ...
    public Set<InterfaceObj> getInterfaceObjSet() {
        return interfaceObjSet;
    }

    public void setInterfaceObjSet(Set<InterfaceObj> interfaceObjSet) {
        this.interfaceObjSet = interfaceObjSet;
    }
}

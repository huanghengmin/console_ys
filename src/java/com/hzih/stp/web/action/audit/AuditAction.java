...
public class AuditAction extends ActionSupport{
    ...
    public String selectManagerAudit() throws Exception {
        ...
        try {
            ...
            json = auditService.selectManagerAudit(start/limit+1, limit,startDate,endDate,logLevel,userName );
            logService.newManagerLog("INFO", SessionUtils.getAccount(request).getUserName(), "管理员日志审计","读取管理员日志审计信息成功 ", 1);
        } catch (Exception e) {
            logger.error("管理员日志审计", e);
            logService.newManagerLog("ERROR", SessionUtils.getAccount(request).getUserName(), "管理员日志审计","读取管理员日志审计信息失败 ", 0);
        }
    ...
    public String selectUserAudit() throws Exception {
        ...
        try {
            ...
            logService.newManagerLog("INFO", SessionUtils.getAccount(request).getUserName(), "用户日志审计","读取用户日志审计信息成功 ", 1);
        } catch (Exception e) {
            logger.error("用户日志审计", e);
            logService.newManagerLog("ERROR", SessionUtils.getAccount(request).getUserName(), "用户日志审计","读取用户日志审计信息失败 ", 0);
        }
        actionBase.actionEnd(response, json, result);
        return null;
    }
    ...
    public String selectOSAudit() throws Exception {
        ...
        try {
            ...
            logService.newManagerLog("INFO", SessionUtils.getAccount(request).getUserName(), "系统日志审计","读取系统日志审计信息成功 ", 1);
        } catch (Exception e) {
            logger.error("系统日志审计", e);
            logService.newManagerLog("ERROR", SessionUtils.getAccount(request).getUserName(), "系统日志审计","读取系统日志审计信息失败 ", 0);
        }
        actionBase.actionEnd(response, json, result);
        return null;
    }
    ...
    public String selectEquipmentAudit() throws Exception {
        ...
        try {
            ...
            logService.newManagerLog("INFO", SessionUtils.getAccount(request).getUserName(), "设备日志审计","读取设备日志审计信息成功 ", 1);
        } catch (Exception e) {
            logger.error("设备日志审计", e);
            logService.newManagerLog("ERROR", SessionUtils.getAccount(request).getUserName(), "设备日志审计","读取设备日志审计信息失败 ", 0);
        }
        actionBase.actionEnd(response, json, result);
        return null;
    }
    ...
    public String selectBusinessAudit() throws Exception {
        ...
        try {
            ...
            logService.newManagerLog("INFO", SessionUtils.getAccount(request).getUserName(), "业务日志审计","读取业务日志审计信息成功 ", 1);
        } catch (Exception e) {
            logger.error("业务日志审计", e);
            logService.newManagerLog("ERROR", SessionUtils.getAccount(request).getUserName(), "业务日志审计","读取业务日志审计信息失败 ", 0);
        }
        actionBase.actionEnd(response, json, result);
        return null;
    }
    ...
    public String truncateEquipment() throws Exception {
        ...
        try {
            ...
            if(auditAccount!=null) {
                ...
                msg = "清空成功,点击[确定]返回列表!";
                logService.newManagerLog("INFO", SessionUtils.getAccount(request).getUserName(), "设备日志审计","清空设备日志审计信息成功 ", 1);
            } else {
                msg = "密码错误!";
                logService.newManagerLog("ERROR", SessionUtils.getAccount(request).getUserName(), "设备日志审计","清空设备日志审计信息失败,密码错误 ", 0);
            }
        } catch (Exception e) {
            logger.error("设备日志审计", e);
            logService.newManagerLog("ERROR", SessionUtils.getAccount(request).getUserName(), "设备日志审计","清空设备日志审计信息失败 ", 0);
    ...
    public String truncateBusiness() throws Exception {
        ...
        try {
            ...
            if(auditAccount!=null) {
                ...
                msg = "清空成功,点击[确定]返回列表!";
                logService.newManagerLog("INFO", SessionUtils.getAccount(request).getUserName(), "业务日志审计","清空设业务志审计信息成功 ", 1);
            } else {
                msg = "密码错误!";
                logService.newManagerLog("ERROR", SessionUtils.getAccount(request).getUserName(), "业务日志审计","清空设业务志审计信息失败,密码错误 ", 0);
            }
        } catch (Exception e) {
            logger.error("业务日志审计", e);
            logService.newManagerLog("ERROR", SessionUtils.getAccount(request).getUserName(), "业务日志审计","清空业务日志审计信息失败 ", 0);
            msg = "清空失败"+e.getMessage();
        }
        String json =  "{success:true,msg:'"+msg+"'}";
        actionBase.actionEnd(response, json, result);

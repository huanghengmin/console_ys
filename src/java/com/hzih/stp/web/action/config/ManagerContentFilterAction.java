...
public class ManagerContentFilterAction extends ActionSupport {
    ...
    public String select() throws Exception {
        ...
        try{
            ...
            logService.newManagerLog("INFO", SessionUtils.getAccount(request).getUserName(), "过滤管理", "查找过滤信息成功", 1);
        } catch (Exception e){
            logger.error("过滤管理",e);
            logService.newManagerLog("ERROR", SessionUtils.getAccount(request).getUserName(), "过滤管理", "查找过滤信息失败", 0);
        }
	...
	public String insert() throws Exception {
        ...
        try {
            ...
            logService.newManagerLog("INFO", SessionUtils.getAccount(request).getUserName(), "过滤管理", "新增过滤信息成功", 1);
        }catch (Exception e) {
            logger.error("过滤管理", e);
            logService.newManagerLog("ERROR", SessionUtils.getAccount(request).getUserName(), "过滤管理", "新增过滤信息失败", 0);
	...
	public String delete() throws Exception {
        ...
        try{
            ...
            logService.newManagerLog("INFO", SessionUtils.getAccount(request).getUserName(), "过滤管理", "删除过滤信息成功", 1);
        }catch (Exception e) {
            logger.info("过滤管理",e);
            logService.newManagerLog("ERROR", SessionUtils.getAccount(request).getUserName(), "过滤管理", "删除过滤信息失败", 0);
	...
	public String update() throws Exception {
        ...
        try{
            ...
            logService.newManagerLog("INFO", SessionUtils.getAccount(request).getUserName(), "过滤管理", "修改过滤信息成功", 1);
        }catch (Exception e) {
            logger.info("过滤管理",e);
            logService.newManagerLog("ERROR", SessionUtils.getAccount(request).getUserName(), "过滤管理", "修改过滤信息失败", 0);

...
public class EquipmentAction extends ActionSupport {
	...
	public String select() throws Exception {
        ...
        try{
            ...
            logService.newManagerLog("INFO",SessionUtils.getAccount(request).getUserName(),"设备管理","查找设备信息成功", 1);

        } catch (Exception e){
            logger.error("设备管理",e);
            logService.newManagerLog("ERROR",SessionUtils.getAccount(request).getUserName(),"设备管理","查找设备信息失败", 0);
        }
    ...
    public String insert() throws Exception {
        ...
        try{
            ...
            logService.newManagerLog("INFO",SessionUtils.getAccount(request).getUserName(),"设备管理","新增设备信息成功", 1);
            ...
            equipmentLog.setLogInfo(""+SessionUtils.getAccount(request).getUserName()+"新增一台设备"+equipment.getEquipmentDesc()+"成功");
            equipmentLog.setLogTime(new Date());
            logService.newEquipmentLog(equipmentLog);
        } catch (Exception e){
            logger.error("设备管理",e);
            logService.newManagerLog("ERROR",SessionUtils.getAccount(request).getUserName(),"设备管理","新增设备信息失败", 0);
            EquipmentLog equipmentLog = new EquipmentLog();
            equipmentLog.setEquipmentName(equipment.getEquipmentName());
            equipmentLog.setLevel("ERROR");
            equipmentLog.setLinkName(equipment.getLinkName());
            equipmentLog.setLogInfo(""+SessionUtils.getAccount(request).getUserName()+"新增一台设备"+equipment.getEquipmentDesc()+"失败");
            equipmentLog.setLogTime(new Date());
            logService.newEquipmentLog(equipmentLog);
            msg = "新增设备失败";
        }
    ...
    public String delete() throws Exception {
        ...
        try{
            ...
            logService.newManagerLog("INFO",SessionUtils.getAccount(request).getUserName(),"设备管理","删除设备信息成功", 1);
            EquipmentLog equipmentLog = new EquipmentLog();
            equipmentLog.setEquipmentName(equipmentName);
            equipmentLog.setLevel("INFO");
            equipmentLog.setLinkName(linkName);
            equipmentLog.setLogInfo(""+SessionUtils.getAccount(request).getUserName()+"删除一台设备"+equipmentDesc+"成功");
            equipmentLog.setLogTime(new Date());
            logService.newEquipmentLog(equipmentLog);
        } catch (Exception e){
            logger.error("设备管理",e);
            logService.newManagerLog("ERROR",SessionUtils.getAccount(request).getUserName(),"设备管理","删除设备信息失败", 0);
            EquipmentLog equipmentLog = new EquipmentLog();
            equipmentLog.setEquipmentName(equipmentName);
            equipmentLog.setLevel("ERROR");
            equipmentLog.setLinkName(linkName);
            equipmentLog.setLogInfo(""+SessionUtils.getAccount(request).getUserName()+"删除一台设备"+equipmentDesc+"失败");
            equipmentLog.setLogTime(new Date());
            logService.newEquipmentLog(equipmentLog);
            msg = "删除设备失败";
        }
    ...
    public String update() throws Exception {
        ...
        try{
            ...
            logService.newManagerLog("INFO",SessionUtils.getAccount(request).getUserName(),"设备管理","修改设备信息成功", 1);
            EquipmentLog equipmentLog = new EquipmentLog();
            equipmentLog.setEquipmentName(equipment.getEquipmentName());
            equipmentLog.setLevel("INFO");
            equipmentLog.setLinkName(equipment.getLinkName());
            equipmentLog.setLogInfo(""+SessionUtils.getAccount(request).getUserName()+"修改设备"+equipment.getEquipmentDesc()+"成功");
            equipmentLog.setLogTime(new Date());
            logService.newEquipmentLog(equipmentLog);
        } catch (Exception e){
            logger.error("设备管理",e);
            logService.newManagerLog("ERROR",SessionUtils.getAccount(request).getUserName(),"设备管理","修改设备信息失败", 0);
            EquipmentLog equipmentLog = new EquipmentLog();
            equipmentLog.setEquipmentName(equipment.getEquipmentName());
            equipmentLog.setLevel("ERROR");
            equipmentLog.setLinkName(equipment.getLinkName());
            equipmentLog.setLogInfo(""+SessionUtils.getAccount(request).getUserName()+"修改设备"+equipment.getEquipmentDesc()+"失败");
            equipmentLog.setLogTime(new Date());
            logService.newEquipmentLog(equipmentLog);
            msg = "修改设备失败";
        }
    ...
    public String checkEquipmentName() throws Exception {
        ...
        try{
            ...
            logService.newManagerLog("INFO",SessionUtils.getAccount(request).getUserName(),"设备管理","检查新增设备编号是否已经存在成功", 1);
        } catch (Exception e){
            logger.error("设备管理",e);
            logService.newManagerLog("ERROR",SessionUtils.getAccount(request).getUserName(),"设备管理","检查新增设备编号是否已经存在失败", 0);
            msg = "检查设备编号失败";
        }
        String json = "{success:true,msg:'"+msg+"'}";
        actionBase.actionEnd(response,json,result);
    ...
    public String checkEquipmentDesc() throws Exception {
        ...
        try{
            ...
            logService.newManagerLog("INFO",SessionUtils.getAccount(request).getUserName(),"设备管理","检查新增设备名["+equipmentDesc+"]是否已经存在成功", 1);
        } catch (Exception e){
            logger.error("设备管理",e);
            logService.newManagerLog("ERROR",SessionUtils.getAccount(request).getUserName(),"设备管理","检查新增设备名是否已经存在失败", 0);
            msg = "检查设备名失败";
        }
        String json = "{success:true,msg:'"+msg+"'}";
        actionBase.actionEnd(response,json,result);
    ...
    public String selectDepartmentNameKeyValue() throws Exception {
        ...
        try{
            ...
            logService.newManagerLog("INFO",SessionUtils.getAccount(request).getUserName(),"设备管理","获取所有部门名列表成功", 1);
        } catch (Exception e){
            logger.error("设备管理",e);
            logService.newManagerLog("ERROR",SessionUtils.getAccount(request).getUserName(),"设备管理","获取所有部门名列表失败", 0);
        }
        actionBase.actionEnd(response,json,result);
		return null;
	}
    ...
    public String selectEquipmentNameKeyValue() throws Exception {
        ...
        try{
            ...
            logService.newManagerLog("INFO",SessionUtils.getAccount(request).getUserName(),"设备日志审计","获取所有设备名列表成功", 1);
        } catch (Exception e){
            logger.error("设备日志审计",e);
            logService.newManagerLog("ERROR",SessionUtils.getAccount(request).getUserName(),"设备日志审计","获取所有设备名列表失败", 0);
        }
        actionBase.actionEnd(response,json,result);
		return null;
	}
    ...
    public String download() throws Exception {
        ...
        try {
            ...
            logService.newManagerLog("INFO",  SessionUtils.getAccount(request).getUserName(), "下载设备系统配置","下载设备系统配置成功", 1);
            json = "{success:true}";
        } catch (Exception e) {
            logger.error("下载设备系统配置", e);
            logService.newManagerLog("ERROR", SessionUtils.getAccount(request).getUserName(), "下载设备系统配置","下载设备系统配置失败", 0);
        }
        actionBase.actionEnd(response,json,result);
        return null;
    }

...
public class PlatformConfigAction extends ActionSupport {
    ...
    public String selectChangeUtils () throws IOException {
        ...
        try {
            ...
            logService.newManagerLog("INFO", SessionUtils.getAccount(request).getUserName(), "平台配置","用户读取平台信息成功 ", 1);
        } catch (Exception e) {
            logger.error("平台配置", e);
            logService.newManagerLog("ERROR", SessionUtils.getAccount(request).getUserName(), "平台配置","用户读取平台信息失败 ", 0);
    ...
    public String updateChangeUtils () throws IOException {
        ...
        try {
            ...
            logService.newManagerLog("INFO", SessionUtils.getAccount(request).getUserName(), "平台配置","用户保存平台信息成功 ", 1);
            msg = "保存成功,点击[确定]返回页面!";
        } catch (Exception e) {
            logger.error("平台配置", e);
            logService.newManagerLog("ERROR", SessionUtils.getAccount(request).getUserName(), "平台配置","用户保存平台信息失败 ", 0);
            msg = "保存失败";
        }
    ...
    public String saveRestartTime () throws IOException {
        ...
        try {
            ...
            logService.newManagerLog("INFO", SessionUtils.getAccount(request).getUserName(), "平台配置","用户设置重启策略成功 ", 1);
            msg = "保存成功,点击[确定]返回页面!";
        } catch (Exception e) {
            logger.error("平台配置", e);
            logService.newManagerLog("ERROR", SessionUtils.getAccount(request).getUserName(), "平台配置","用户设置重启策略失败 ", 0);
            msg = "保存失败";
        }
        String json = "{success:true,msg:'"+msg+"'}";
        actionBase.actionEnd(response,json,result);
    ...
    public String readSNMPIp () throws IOException {
        ...
        try {
            ...
            logService.newManagerLog("INFO", SessionUtils.getAccount(request).getUserName(), "平台配置","用户读取SNMP信息成功 ", 1);
        } catch (Exception e) {
            logger.error("平台配置", e);
            logService.newManagerLog("ERROR", SessionUtils.getAccount(request).getUserName(), "平台配置","用户读取SNMP失败 ", 0);
            json = "{success:true,total:0,rows[]}";
        }
        actionBase.actionEnd(response,json,result);
        return null;
    ...
    public String readSysLogIp () throws IOException {
        ...
        try {
            ...
            logService.newManagerLog("INFO", SessionUtils.getAccount(request).getUserName(), "平台配置","用户读取SysLog信息成功 ", 1);
        } catch (Exception e) {
            logger.error("平台配置", e);
            logService.newManagerLog("ERROR", SessionUtils.getAccount(request).getUserName(), "平台配置","用户读取SysLog失败 ", 0);
            json = "{success:true,total:0,rows[]}";
        }
        actionBase.actionEnd(response,json,result);
        return null;
    ...
    public String checkSNMPClient () throws IOException {
        ...
        try {
            ...
            if(pattern.matcher(snmpclient).matches()){
                ...
                logService.newManagerLog("INFO", SessionUtils.getAccount(request).getUserName(), "平台配置","用户校验SNMP的IP是否已经存在成功 ", 1);
            }else{
                msg = "输入格式不对,请重新输入!";
                logService.newManagerLog("WARN", SessionUtils.getAccount(request).getUserName(), "平台配置","用户校验SNMP的IP,输入格式不对 ", 0);
            }
        } catch (Exception e) {
            logger.error("平台配置", e);
            logService.newManagerLog("ERROR", SessionUtils.getAccount(request).getUserName(), "平台配置","用户校验SNMP的IP是否已经存在失败 ", 0);
            msg = "校验失败";
        }
        String json = "{success:true,msg:'"+msg+"'}";
        actionBase.actionEnd(response,json,result);
    ...
    public String checkSysLogClient () throws IOException {
        ...
        try {
            ...
            if(pattern.matcher(syslogclient).matches()){
                ...
                logService.newManagerLog("INFO", SessionUtils.getAccount(request).getUserName(), "平台配置","用户校验SysLog的IP是否已经存在成功 ", 1);
            }else{
                msg = "输入格式不对,请重新输入!";
                logService.newManagerLog("WARN", SessionUtils.getAccount(request).getUserName(), "平台配置","用户校验SysLog的IP,输入格式不对 ", 0);
            }
        } catch (Exception e) {
            logger.error("平台配置", e);
            logService.newManagerLog("ERROR", SessionUtils.getAccount(request).getUserName(), "平台配置","用户校验SysLog的IP是否已经存在失败 ", 0);
            msg = "校验失败";
        }
        String json = "{success:true,msg:'"+msg+"'}";
        actionBase.actionEnd(response,json,result);
    ...
    public String saveSNMP () throws IOException {
        ...
        try {
            ...
            logService.newManagerLog("INFO", SessionUtils.getAccount(request).getUserName(), "平台配置","用户保存SNMP信息成功 ", 1);
            msg="保存成功,点击[确定]返回表格!";
        } catch (Exception e) {
            logger.error("平台配置", e);
            logService.newManagerLog("ERROR", SessionUtils.getAccount(request).getUserName(), "平台配置","用户保存SNMP信息失败 ", 0);
            msg = "保存失败";
        }
        String json = "{success:true,msg:'"+msg+"'}";
        actionBase.actionEnd(response,json,result);
    ...
    public String saveSysLog () throws IOException {
        ...
        try {
            ...
            logService.newManagerLog("INFO", SessionUtils.getAccount(request).getUserName(), "平台配置","用户保存SysLog信息成功 ", 1);
            msg="保存成功,点击[确定]返回表格!";
        } catch (Exception e) {
            logger.error("平台配置", e);
            logService.newManagerLog("ERROR", SessionUtils.getAccount(request).getUserName(), "平台配置","用户保存SysLog信息失败 ", 0);
            msg = "保存失败";
        }
        String json = "{success:true,msg:'"+msg+"'}";
        actionBase.actionEnd(response,json,result);
    ...
    public String deleteSNMP () throws IOException {
        ...
        try {
            ...
            logService.newManagerLog("INFO", SessionUtils.getAccount(request).getUserName(), "平台配置","用户删除SNMP信息成功 ", 1);
            msg="删除成功,点击[确定]返回表格!";
        } catch (Exception e) {
            logger.error("平台配置", e);
            logService.newManagerLog("ERROR", SessionUtils.getAccount(request).getUserName(), "平台配置","用户删除SNMP信息失败 ", 0);
            msg = "删除失败";
        }
        String json = "{success:true,msg:'"+msg+"'}";
        actionBase.actionEnd(response,json,result);
    ...
    public String deleteSysLog () throws IOException {
        ...
        try {
            ...
            logService.newManagerLog("INFO", SessionUtils.getAccount(request).getUserName(), "平台配置","用户删除SysLog信息成功 ", 1);
            msg="删除成功,点击[确定]返回表格!";
        } catch (Exception e) {
            logger.error("平台配置", e);
            logService.newManagerLog("ERROR", SessionUtils.getAccount(request).getUserName(), "平台配置","用户删除SysLog信息失败 ", 0);
            msg = "删除失败";
        }
        String json = "{success:true,msg:'"+msg+"'}";
        actionBase.actionEnd(response,json,result);
    ...
    public String updateSNMP () throws IOException {
        ...
        try {
            ...
            logService.newManagerLog("INFO", SessionUtils.getAccount(request).getUserName(), "平台配置","用户修改SNMP信息成功 ", 1);
            msg="修改成功,点击[确定]返回表格!";
        } catch (Exception e) {
            logger.error("平台配置", e);
            logService.newManagerLog("ERROR", SessionUtils.getAccount(request).getUserName(), "平台配置","用户修改SNMP信息失败 ", 0);
            msg = "修改失败";
        }
        String json = "{success:true,msg:'"+msg+"'}";
        actionBase.actionEnd(response,json,result);
    ...
    public String updateSysLog () throws IOException {
        ...
        try {
            ...
            logService.newManagerLog("INFO", SessionUtils.getAccount(request).getUserName(), "平台配置","用户修改SysLog信息成功 ", 1);
            msg="修改成功,点击[确定]返回表格!";
        } catch (Exception e) {
            logger.error("平台配置", e);
            logService.newManagerLog("ERROR", SessionUtils.getAccount(request).getUserName(), "平台配置","用户修改SysLog信息失败 ", 0);
            msg = "修改失败";
        }
        String json = "{success:true,msg:'"+msg+"'}";
        actionBase.actionEnd(response,json,result);

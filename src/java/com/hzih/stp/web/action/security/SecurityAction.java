...
public class SecurityAction extends ActionSupport {
    ...
    public String selectBiz()throws IOException {
        ...
        try{
            ...
            logService.newManagerLog("INFO", SessionUtils.getAccount(request).getUserName(),"业务异常报警","读取业务异常报警列表成功", 1);
        }catch (Exception ex){
            logger.error("业务异常报警",ex);
            logService.newManagerLog("ERROR", SessionUtils.getAccount(request).getUserName(),"业务异常报警","读取业务异常报警列表失败", 0);
    ...
    public String biz()throws IOException {
        ...
        try{
            ...
            logService.newManagerLog("INFO", SessionUtils.getAccount(request).getUserName(),"组建业务列表","组建业务列表成功", 1);
        }catch (Ex ex){
            logger.error("组建业务列表",ex);
            logService.newManagerLog("ERROR", SessionUtils.getAccount(request).getUserName(),"组建业务列表","组建业务列表失败", 0);
        }
        base.actionEnd(response, json ,result);
        return null;
    }
    ...
    public String alertTypeBiz() throws IOException{
        ...
        try{
            ...
            logService.newManagerLog("INFO", SessionUtils.getAccount(request).getUserName(),"业务异常报警","组建业务异常列表成功", 1);
        }catch (Exception ex){
            logger.error("业务异常报警",ex);
            logService.newManagerLog("ERROR", SessionUtils.getAccount(request).getUserName(),"业务异常报警","组建业务异常列表失败", 0);
        }
        base.actionEnd(response, json ,result);
        return null;
    }
    ...
    public String setBizRead() throws IOException{
        ...
        try{
            ...
            logService.newManagerLog("INFO", SessionUtils.getAccount(request).getUserName(),"业务异常报警","标记业务异常记录为已读成功", 1);
            msg = "标记成功";
        }catch (Exception ex){
            logger.error("业务异常报警",ex);
            logService.newManagerLog("ERROR", SessionUtils.getAccount(request).getUserName(),"业务异常报警","标记业务异常记录为已读失败", 0);
            msg = "标记失败";
        }
    ...
    public String selectEqu()throws IOException {
        ...
        try{
            ...
            logService.newManagerLog("INFO", SessionUtils.getAccount(request).getUserName(),"设备故障报警","组建设备故障报警列表成功", 1);
        }catch (Exception ex){
            logger.error("设备故障报警",ex);
            logService.newManagerLog("ERROR", SessionUtils.getAccount(request).getUserName(),"设备故障报警","组建设备故障报警列表失败", 0);
            json = "{success:true,total:0,rows:[]}";
        }
        base.actionEnd(response, json ,result);
        return null;
    ...
    public String setEquRead()throws IOException {
        ...
        try{
            ...
            logService.newManagerLog("INFO", SessionUtils.getAccount(request).getUserName(),"设备故障报警","标记设备故障记录为已读成功", 1);
            msg = "标记成功";
        }catch (Exception ex){
            logger.error("设备故障报警",ex);
            logService.newManagerLog("ERROR", SessionUtils.getAccount(request).getUserName(),"设备故障报警","标记设备故障记录为已读失败", 0);
            msg = "标记失败";
        }
        String json = "{success:true,msg:'"+msg+"'}";
        base.actionEnd(response, json ,result);
    ...
    public String equ()throws IOException {
        ...
        try{
            ...
            logService.newManagerLog("INFO", SessionUtils.getAccount(request).getUserName(),"组建设备名列表","组建设备名列表成功", 1);
        }catch (Exception ex){
            logger.error("组建设备名列表",ex);
            logService.newManagerLog("ERROR", SessionUtils.getAccount(request).getUserName(),"组建设备名列表","组建设备名列表失败", 0);
        }
        base.actionEnd(response, json ,result);
        return null;
    }
    ...
    public String selectEvent()throws IOException {
        ...
        try{
            ...
            logService.newManagerLog("INFO", SessionUtils.getAccount(request).getUserName(),"安全事件报警","组建安全事件报警列表成功", 1);
            name = null;
        }catch (Exception ex){
            logger.error("安全事件报警",ex);
            logService.newManagerLog("ERROR", SessionUtils.getAccount(request).getUserName(),"安全事件报警","组建安全事件报警列表失败", 0);
            json = "{success:true,total:0,rows:[]}";
        }
        base.actionEnd(response, json ,result);
        return null;
    ...
    public String alertTypeEvent()throws IOException {
        ...
        try{
            ...
            logService.newManagerLog("INFO", SessionUtils.getAccount(request).getUserName(),"安全事件报警","组建安全事件报警类型列表成功", 1);
        }catch (Exception ex){
            logger.error("安全事件报警",ex);
            logService.newManagerLog("ERROR", SessionUtils.getAccount(request).getUserName(),"安全事件报警","组建安全事件报警类型列表失败", 0);
        }
        base.actionEnd(response, json ,result);
        return null;
    }
    ...
    public String setEventRead()throws IOException {
        ...
        try{
            ...
            logService.newManagerLog("INFO", SessionUtils.getAccount(request).getUserName(),"安全事件报警","标记安全事件记录为已读成功", 1);
            msg = "标记成功";
        }catch (Exception ex){
            logger.error("安全事件报警",ex);
            logService.newManagerLog("ERROR", SessionUtils.getAccount(request).getUserName(),"安全事件报警","标记安全事件记录为已读失败", 0);
            msg = "标记失败";
        }
        String json = "{success:true,msg:'"+msg+"'}";
        base.actionEnd(response, json ,result);
    ...
    public String system()throws IOException {
        ...
        try{
            ...
            logService.newManagerLog("INFO", SessionUtils.getAccount(request).getUserName(),"组建系统事件列表","组建系统事件列表成功", 1);
        }catch (Exception ex){
            logger.error("组建系统事件列表",ex);
            logService.newManagerLog("ERROR", SessionUtils.getAccount(request).getUserName(),"组建系统事件列表","组建系统事件列表失败", 0);
            json ="{success:true,total:0,rows:[]}";
        }
        base.actionEnd(response, json ,result);
        return null;

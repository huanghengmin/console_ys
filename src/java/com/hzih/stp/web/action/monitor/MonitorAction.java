...
import com.hzih.stp.web.thread.SystemStatusService;
...
//            logService.newManagerLog("INFO", SessionUtils.getAccount(request).getUserName(),"业务运行监控","读取业务监控信息成功!");
        } catch (Exception e){
            logger.error("业务运行监控",e);
            logService.newManagerLog("ERROR", SessionUtils.getAccount(request).getUserName(),"业务运行监控","读取业务监控信息失败!", 0);
...
//            logService.newManagerLog("INFO", SessionUtils.getAccount(request).getUserName(),"设备运行监控","读取设备监控信息成功!");
        } catch (Exception e){
            logger.error("设备运行监控",e);
            logService.newManagerLog("ERROR", SessionUtils.getAccount(request).getUserName(),"设备运行监控","读取平台设备设备监控信息失败!", 0);
            json = "{success:true,total:0,rows:[]}";
        }
        actionBase.actionEnd(response,json);
        return null;
...
//            logService.newManagerLog("INFO", SessionUtils.getAccount(request).getUserName(),"设备运行监控","读取设备监控信息成功!");
            ...
            logger.error("设备运行监控",e);
            logService.newManagerLog("ERROR", SessionUtils.getAccount(request).getUserName(),"设备运行监控","读取外部设备设备监控信息失败!", 0);
            json = "{success:true,total:0,rows:[]}";
        }
        actionBase.actionEnd(response,json);
        return null;
    ...
    public String equipmentRunInfo() throws IOException{
        ...
        try{
            ...
            logService.newManagerLog("INFO", SessionUtils.getAccount(request).getUserName(),"设备运行监控","读取设备"+equipmentName+"运行信息成功!", 1);
        } catch (Exception e){
            logger.error("设备运行监控",e);
            logService.newManagerLog("ERROR", SessionUtils.getAccount(request).getUserName(),"设备运行监控","读取设备"+equipmentName+"运行信息失败!", 0);
            json = "{success:true,total:0,rows:[]}";
        }
        actionBase.actionEnd(response,json);
        return null;
    ...
    public String ping() throws IOException{
        ...
        try{
            ...
            logService.newManagerLog("INFO", SessionUtils.getAccount(request).getUserName(),"设备运行监控","连通测试设备"+equipmentName+"运行IP成功!", 1);
        } catch (Exception e){
            logger.error("设备运行监控",e);
            logService.newManagerLog("ERROR", SessionUtils.getAccount(request).getUserName(),"设备运行监控","连通测试设备"+equipmentName+"运行IP失败!", 0);
            msg = "测试失败";
        }
    ...
    public String telnet() throws IOException{
        ...
        try{
            ...
            logService.newManagerLog("INFO", SessionUtils.getAccount(request).getUserName(),"设备运行监控","设备"+equipmentName+"运行测试端口"+port+"成功!", 1);
        } catch (Exception e){
            logger.error("设备运行监控",e);
            logService.newManagerLog("ERROR", SessionUtils.getAccount(request).getUserName(),"设备运行监控","设备"+equipmentName+"运行测试端口"+port+"失败!", 0);
            msg = "测试失败";
        }
        String json = "{success:true,msg:'"+msg+"'}";
        actionBase.actionEnd(response,json,result);

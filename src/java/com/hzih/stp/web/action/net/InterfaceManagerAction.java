...
public class InterfaceManagerAction extends ActionSupport {
	...
	public String ping() throws IOException {
        ...
        try {
            ...
            logService.newManagerLog("INFO", SessionUtils.getAccount(request).getUserName(), "连通测试","ping成功 ", 1);
        } catch (Exception e) {
            logger.error("连通测试", e);
            logService.newManagerLog("ERROR", SessionUtils.getAccount(request).getUserName(), "连通测试","ping失败 ", 0);
            msg = "ping失败";
        }
	...
	public String telnet() throws Exception{
		...
		try {
            ...
            logService.newManagerLog("INFO", SessionUtils.getAccount(request).getUserName(), "端口测试","telnet成功 ", 1);
        } catch (Exception e) {
            logger.error("端口测试", e);
            logService.newManagerLog("ERROR", SessionUtils.getAccount(request).getUserName(), "端口测试","telnet失败 ", 0);
            msg = "telnet失败";
        }
        json = "{success:true,msg:'"+msg+"'}";
        actionBase.actionEnd(response,json,result);
    ...
    */
    public String readRouter() throws Exception {
        ...
        try {
            ...
            logService.newManagerLog("INFO", SessionUtils.getAccount(request).getUserName(),"路由管理","读取路由信息成功 ", 1);
        } catch (Exception e) {
            logger.error("路由管理", e);
            logService.newManagerLog("ERROR", SessionUtils.getAccount(request).getUserName(),"路由管理","读取路由信息失败 ", 0);
        }
        actionBase.actionEnd(response, json, result);
        return null;
    }
    ...
    */
    public String readInterfaceName() throws Exception {
        ...
        try {
            ...
            logService.newManagerLog("INFO", SessionUtils.getAccount(request).getUserName(), model,"读取所有网口名成功 ", 1);
        } catch (Exception e) {
            logger.error(model, e);
            logService.newManagerLog("ERROR", SessionUtils.getAccount(request).getUserName(), model,"读取所有网口名失败 ", 0);
        }
        actionBase.actionEnd(response, json, result);
        return null;
    }
    ...
    */
    public String saveRouter() throws Exception {
        ...
        try {
            ...
            logService.newManagerLog("INFO", SessionUtils.getAccount(request).getUserName(),"路由管理","新增一个路由信息成功 ", 1);

        } catch (Exception e) {
            logger.error("路由管理", e);
            logService.newManagerLog("ERROR", SessionUtils.getAccount(request).getUserName(),"路由管理","新增一个路由信息失败 ", 0);
            msg = "新增一个路由信息失败";
        }
        json = "{success:true,msg:'"+msg+"'}";
        actionBase.actionEnd(response, json, result);
    ...
    */
    public String deleteRouter() throws Exception {
        ...
        try {
            ...
            logService.newManagerLog("INFO", SessionUtils.getAccount(request).getUserName(),"路由管理","删除路由信息成功 ", 1);
        } catch (Exception e) {
            logger.error("路由管理", e);
            logService.newManagerLog("ERROR", SessionUtils.getAccount(request).getUserName(),"路由管理","删除路由信息失败 ", 0);
            msg = "删除路由信息失败";
        }
        json = "{success:true,msg:'"+msg+"'}";
        actionBase.actionEnd(response, json, result);
    ...
    */
    public String readInterface() throws Exception {
        ...
        try {
            ...
            logService.newManagerLog("INFO", SessionUtils.getAccount(request).getUserName(),"网口管理","读取网口信息成功 ", 1);
        } catch (Exception e) {
            logger.error("网口管理", e);
            logService.newManagerLog("ERROR", SessionUtils.getAccount(request).getUserName(),"网口管理","读取网口信息失败 ", 0);
        }
        actionBase.actionEnd(response, json, result);
        return null;
    }
    ...
    public String readAddInterfaceName() throws Exception{
        ...
        try {
            ...
            logService.newManagerLog("INFO", SessionUtils.getAccount(request).getUserName(), "网口管理","读取可新增网口名成功 ", 1);
        } catch (Exception e) {
            logger.error("网口管理", e);
            logService.newManagerLog("ERROR", SessionUtils.getAccount(request).getUserName(), "网口管理","读取可新增网口名失败 ", 0);
        }
        actionBase.actionEnd(response, json, result);
        return null;
    }
    ...
    public String ifInterfaceUp() throws Exception {
        ...
        try {
            ...
            logService.newManagerLog("INFO", SessionUtils.getAccount(request).getUserName(),"网口管理","激活网口成功 ", 1);
        } catch (Exception e) {
            logger.error("网口管理", e);
            logService.newManagerLog("ERROR", SessionUtils.getAccount(request).getUserName(),"网口管理","激活网口失败 ", 0);
            msg = "激活网口失败";
        }
        json = "{success:true,msg:'"+msg+"'}";
        actionBase.actionEnd(response, json, result);
    ...
    public String ifInterfaceDown() throws Exception {
        ...
        try {
            ...
            logService.newManagerLog("INFO", SessionUtils.getAccount(request).getUserName(),"网口管理","注销网口成功 ", 1);
        } catch (Exception e) {
            logger.error("网口管理", e);
            logService.newManagerLog("ERROR", SessionUtils.getAccount(request).getUserName(),"网口管理","注销网口失败 ", 0);
            msg = "注销网口失败";
        }
        json = "{success:true,msg:'"+msg+"'}";
        actionBase.actionEnd(response, json, result);
    ...
    */
    public String saveInterface() throws Exception {
        ...
        try {
            ...
            logService.newManagerLog("INFO", SessionUtils.getAccount(request).getUserName(),"网口管理","新增虚拟网口信息成功 ", 1);
        } catch (Exception e) {
            logger.error("网口管理", e);
            logService.newManagerLog("ERROR", SessionUtils.getAccount(request).getUserName(),"网口管理","新增虚拟网口信息失败 ", 0);
            msg = "新增虚拟网口信息失败";
        }
        json = "{success:true,msg:'"+msg+"'}";
        actionBase.actionEnd(response, json, result);
    ...
    public String deleteInterface() throws Exception {
        ...
        try {
            ...
            logService.newManagerLog("INFO", SessionUtils.getAccount(request).getUserName(),"网口管理","删除虚拟网口成功 ", 1);
        } catch (Exception e) {
            logger.error("网口管理", e);
            logService.newManagerLog("ERROR", SessionUtils.getAccount(request).getUserName(),"网口管理","删除虚拟网口失败 ", 0);
            msg = "删除虚拟网口失败";
        }
        json = "{success:true,msg:'"+msg+"'}";
        actionBase.actionEnd(response, json, result);
    ...
    public String updateInterface() throws Exception {
        ...
        try {
            ...
            logService.newManagerLog("INFO", SessionUtils.getAccount(request).getUserName(),"网口管理","修改网口信息成功 ", 1);
        } catch (Exception e) {
            logger.error("网口管理", e);
            logService.newManagerLog("ERROR", SessionUtils.getAccount(request).getUserName(),"网口管理","修改网口信息失败 ", 0);
            msg = "修改网口信息失败";
        }
        json = "{success:true,msg:'"+msg+"'}";
        actionBase.actionEnd(response, json, result);
    ...
    public String updateXNInterface() throws Exception {
        ...
        try {
            ...
            NetworkUtil networkUtil = new NetworkUtil();
            msg = networkUtil.updateInterface(netInfo,isUpOlder, gatewayOlder);
            logService.newManagerLog("INFO", SessionUtils.getAccount(request).getUserName(),"网口管理","修改虚拟网口信息成功 ", 1);
        } catch (Exception e) {
            logger.error("网口管理", e);
            logService.newManagerLog("ERROR", SessionUtils.getAccount(request).getUserName(),"网口管理","修改虚拟网口信息失败 ", 0);
            msg = "修改虚拟网口信息失败";
        }
        json = "{success:true,msg:'"+msg+"'}";
        actionBase.actionEnd(response, json, result);
    ...
    public String updateDNS() throws Exception {
        ...
        try {
            ...
            logService.newManagerLog("INFO", SessionUtils.getAccount(request).getUserName(),"网口管理","修改DNS信息成功 ", 1);
        } catch (Exception e) {
            logger.error("网口管理", e);
            logService.newManagerLog("ERROR", SessionUtils.getAccount(request).getUserName(),"网口管理","修改DNS信息失败 ", 0);
            msg = "修改DNS信息失败";
        }
        json = "{success:true,msg:'"+msg+"'}";
        actionBase.actionEnd(response, json, result);

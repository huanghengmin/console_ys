...
public class CheckLoginFilter implements Filter {
    final static Logger logger = Logger.getLogger(CheckLoginFilter.class);
...
//			response.sendRedirect(request.getContextPath() + "/login.jsp");
			...
			if (requestURL.endsWith("action") && requestURL.indexOf("checkTimeout.action") < 0 && requestURL.indexOf("alertRule.action") < 0 && requestURL.indexOf("alert.action") < 0) {

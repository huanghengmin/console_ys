...
public class SecurityLevelServiceImpl implements SecurityLevelService {
    ...
    public String insert(SecurityLevel securityLevel) throws Exception {
        securityLevel.setSecurityLevel(Integer.parseInt(securityLevel.getLevelInfo()));
...
//            securityLevelDao.deleteWithDependent(ids);
    ...
    public String update(SecurityLevel securityLevel) throws Exception {
        ...
        old.setSecurityLevel(Integer.parseInt(securityLevel.getLevelInfo()));
    ...
    @Override
    public SecurityLevel findByLevelInfo(int infoLevel) throws Exception {
        return securityLevelDao.findByLevelInfo(String.valueOf(infoLevel));
    }

...
public class Constant {
    ...
    public final static String S_PROP_QUERY_ALL_TRIGGER = "query_all_trigger";
    ...
    public final static String S_PROC_QUERY_FUNCTION = "query_function";
    public final static String S_PROC_CREATE_FUNCTION_VAR2ARR = "create_function_var2arr";
    public final static String S_PROC_CREATE_FUNCTION_GETTABLENAME="create_function_gettablename";
    public final static String S_PROC_DELTE_FUNCTION_VAR2ARR="delete_function_var2arr";
    public final static String S_PROC_DELETE_FUNCTION_GETTABLENAME="delete_function_gettablename";
    public final static String S_PROC_CREATE_MORE_SEQUENCE = "create_more_sequences";
    public final static String S_PROC_DELETE_MORE_SEQUENCE = "drop_more_sequences";
    public final static String S_PROC_QUERY_MORE_SEQUENCE = "query_more_sequence";
    public final static String S_PROC_INSERT_MORE_TRIGGER = "insert_more_trigger";

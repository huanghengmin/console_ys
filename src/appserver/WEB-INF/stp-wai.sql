...
(200,'TOP_YYGL','应用管理',NULL,0,0),(201,'SECOND_PZGL','批注管理',NULL,200,1),(202,'SECOND_MB_WJTB','目标文件同步',NULL,200,2),(203,'SECOND_MB_DBTB','目标数据库同步',NULL,200,3),(204,'SECOND_MB_TYDL','目标通用代理',NULL,200,4),(205,'SECOND_DKYS','端口映射',NULL,200,5),(206,'SECOND_YD_WJTB','源端文件同步',NULL,200,6),(207,'SECOND_YD_DBTB','源端数据库同步',NULL,200,7),(208,'SECOND_YD_TYDL','源端通用代理',NULL,200,8),(209,'SECOND_YWSJBD','业务审计比对',NULL,200,9),(210,'SECOND_YWSDCC','业务手动重传',NULL,200,10),(211, 'SECOND_WJBJ', '文件标记', NULL,200, 11),(212, 'SECOND_WJLL', '文件浏览',NULL, 200, 12),
...
CREATE TABLE `contentfilter` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='内容过滤表';

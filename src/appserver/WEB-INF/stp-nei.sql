...
(100,'TOP_QXGL','权限管理',NULL,0,0),(101,'SECOND_YHGL','用户管理',NULL,100,1),(102,'SECOND_JSGL','角色管理',NULL,100,2),(103,'SECOND_AQCL','安全策略',NULL,100,3),
(110,'TOP_WLGL','网络管理',NULL,0,0),(111,'SECOND_JKGL','网口管理',NULL,110,1),(112,'SECOND_LYGL','路由管理',NULL,110,2),(113,'SECOND_WLCS','网络测试',NULL,110,3),(114,'SECOND_AQPZ','安全配置',NULL,110,4),
(120,'TOP_XTGL','系统管理',NULL,0,0),(121,'SECOND_PTSM','平台说明',NULL,120,1),(122,'SECOND_INIT_S','平台初始化',NULL,120,2),(123,'SECOND_PTGL','平台管理',NULL,120,3),(124,'SECOND_ZSGL','许可证管理',NULL,120,4),(125,'SECOND_RZXZ','日志下载',NULL,120,5),(126,'SECOND_BBSJ','版本升级',NULL,120,6),(127,'SECOND_YD_PZHF','源端配置恢复',NULL,120,7),(128,'SECOND_MB_PZHF','目标配置恢复',NULL,120,8),(129,'SECOND_YD_PZWJGL','源端配置文件管理',NULL,120,9),(130,'SECOND_MB_PZWJGL','目标配置文件管理',NULL,120,10),(131,'SECOND_PTPZ','平台配置',NULL,120,11),(132,'SECOND_HFCCSZ','恢复出厂设置',NULL,120,12),(133,'SECOND_INIT_T','平台初始化',NULL,120,13),
(140,'TOP_PZGL','配置管理',NULL,0,0),(141,'SECOND_SJKPZ','审计库配置',NULL,140,1),(142,'SECOND_BJPZ','报警配置',NULL,140,2),(143,'SECOND_SBPZ','设备配置',NULL,140,3),(144,'SECOND_SJRB','双机热备',NULL,140,4),(145,'SECOND_XXAQCL','信息安全策略',NULL,140,5),(146,'SECOND_GLPZ','过滤配置',NULL,140,6),
(160,'TOP_SJGL','审计日志',NULL,0,0),(161,'SECOND_YHRZ','管理员日志',NULL,160,1),(162,'SECOND_SBRZ','设备日志',NULL,160,2),(163,'SECOND_YWRZ','业务日志',NULL,160,3),(166,'SECOND_XTRZ','系统日志',NULL,160,6),
(170,'TOP_BJGL','报警管理',NULL,0,0),(171,'SECOND_YWYCBJ','业务异常报警',NULL,170,1),(172,'SECOND_AQSJBJ','安全事件报警',NULL,170,2),(173,'SECOND_SBGZBJ','设备故障报警',NULL,170,3),
(180,'TOP_YXJK','运行监控',NULL,0,0),(181,'SECOND_YWYXJK','业务运行监控',NULL,180,1),(182,'SECOND_SBYXJK','设备运行监控',NULL,180,2),
(190,'TOP_SJYGL','数据源管理',NULL,0,0),(191,'SECOND_YDSJY','源端数据源',NULL,190,1),(192,'SECOND_MBSJY','目标数据源',NULL,190,2),
(200,'TOP_YYGL','应用管理',NULL,0,0),(201,'SECOND_PZGL','未通过审核的应用',NULL,200,1),(202,'SECOND_MB_WJTB','目标文件同步',NULL,200,2),(203,'SECOND_MB_DBTB','目标数据库同步',NULL,200,3),(204,'SECOND_MB_TYDL','目标通用代理',NULL,200,4),(205,'SECOND_DKYS','端口映射',NULL,200,5),(206,'SECOND_YD_WJTB','源端文件同步',NULL,200,6),(207,'SECOND_YD_DBTB','源端数据库同步',NULL,200,7),(208,'SECOND_YD_TYDL','源端通用代理',NULL,200,8),(209,'SECOND_YWSJBD','业务审计比对',NULL,200,9),(210,'SECOND_YWSDCC','业务手动重传',NULL,200,10),(211, 'SECOND_WJBJ', '文件标记', NUll,200, 11),(212, 'SECOND_WJLL', '文件浏览', NUll,200, 12),
(220,'TOP_SHGL','审核管理',NULL,0,0),(221,'SECOND_YD_WJTBSH','源端文件同步审核',NULL,220,1),(222,'SECOND_MB_WJTBSH','目标文件同步审核',NULL,220,2),(223,'SECOND_YD_DBTBSH','源端数据库同步审核',NULL,220,3),(224,'SECOND_MB_DBTBSH','目标数据库同步审核',NULL,220,4),(225,'SECOND_YD_TYDLSH','源端通用代理审核',NULL,220,5),(226,'SECOND_MB_TYDLSH','目标通用代理审核',NULL,220,6),
(230,'TOP_RZGL','认证管理',NULL,0,0),(231, 'SECOND_RZZHGL', '认证账号管理', NULL, 230, 1),(232, 'SECOND_FWZHGL', '服务账号管理', NULL, 230, 2),(233, 'SECOND_RZKHD', '认证客户端', NULL, 230, 3);
UNLOCK TABLES;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='角色类型表';
...
CREATE TABLE IF NOT EXISTS `role` (
  ...
  `roleType` varchar(30) COLLATE utf8_bin NOT NULL,
...
INSERT INTO `role` (`id`, `name`, `roleType`, `description`, `createdTime`, `modifiedTime`) VALUES
	(1, '初始化管理员', '001', '初始化管理员', '2010-07-04 15:07:08', '2013-01-18 12:25:26'),
	(2, '授权管理员', '002', '授权管理员', '2012-07-03 10:06:20', '2012-11-02 10:11:49'),
	(3, '配置管理员', '004', '配置管理员', '2012-03-14 12:33:05', '2012-09-29 15:28:03'),
	(4, '审计管理员', '003', '审计管理员', '2012-06-12 18:37:24', '2012-09-21 08:58:39'),
	(5, '授权测试', '002', '授权的测试角色', '2013-01-19 16:14:28', '2013-02-26 11:21:45');
UNLOCK TABLES;
...
INSERT INTO `account_security` (`id`, `isFilter`, `isVirusScan`, `infoLevel`) VALUES
	(1, 0, 0, '0'),
	(2, 0, 0, '0'),
	(3, 0, 0, '0'),
	(4, 0, 0, '0'),
...
INSERT INTO `contentfilter` VALUES (1,'异常一'),(2,'替换二');
UNLOCK TABLES;
...
CREATE TABLE IF NOT EXISTS `delete_status` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=0 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='应用删除状态表';
...
CREATE TABLE `equipment` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=0 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='设备表';
...
CREATE TABLE `equipment_alert` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=0 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='设备告警阀值信息';
...
CREATE TABLE `equipment_log` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=0 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='设备日志表';
...
CREATE TABLE `equipment_security_alert` (
  ...
  `alert_info` varchar(500) COLLATE utf8_bin NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=0 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='设备故障报警信息';
...
CREATE TABLE `ext_link` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=0 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='外部链路表';
...
CREATE TABLE `int_link` (
  ...
  `other_security` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=0 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='内部链路表';
...
CREATE TABLE `safe_event_security_alert` (
  ...
  `alert_info` varchar(500) COLLATE utf8_bin NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=0 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='安全事件报警信息';
...
CREATE TABLE `sys_log` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=0 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='系统日志审计表';
...
CREATE TABLE `type_check` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=0 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='应用批注表';
...
CREATE TABLE `user_oper_log` (
  ...
  `audit_info` varchar(255) CHARACTER SET utf8 DEFAULT NULL COMMENT '审计内容',
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=0 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='用户操作审计表';
...
CREATE TABLE `business_log_handle_db` (
    ...
    PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=0 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='业务日志处理,重传统计';

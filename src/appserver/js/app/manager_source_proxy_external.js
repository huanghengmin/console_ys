    ...
    //应用属性配置
     var form1 = new Ext.form.FormPanel({
        ...
        items:[{
            ...
            regex:/^((7700|7[0-6][0-9][02468]|6[7-9][0-9][02468])|(7700|7[0-6][0-9][02468]|6[7-9][0-9][02468])[:](7700|7[0-6][0-9][02468]|6[7-9][0-9][02468]))$/,
            regexText:'这个不是正确输入类型(例子:6700~7700之间任一或者任意2个偶数6700:7700)',
            emptyText:'请输入6700~7700或6700:7700',
            listeners:{
                blur:function(){

    ...
    var formPanel = new Ext.form.FormPanel({
        ...
        items: [{
            ...
            items: [{
                ...
                //点击事件
                handler: function () {
                    var serviceId = Ext.getCmp("test.interfaceNumer").getValue();
                    var queryStr = Ext.getCmp("test.queryStr").getValue();
                    var policeId = Ext.getCmp("test.policeId").getValue();
                    var start = Ext.getCmp("test.start").getValue();
                    var end = Ext.getCmp("test.end").getValue();
                    Ext.Ajax.request({

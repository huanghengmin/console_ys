...
Ext.onReady(function(){
    ...
    var record = new Ext.data.Record.create([
        ...
        {name:'backupdirdelete',mapping:'backupdirdelete'},
    ...
    var button = new Ext.Panel({
        ...
        autoScroll:true,
        buttons:[
        	new Ext.Toolbar.Spacer({width:230}),
            {
                text:"保存",
    ...
    var initForm1 = new Ext.form.FormPanel({
        ...
        items:[{
            ...
            {                       //<recover>10</recover><!--数据恢复频率-->
                ...
                fieldLabel:"病毒扫描程序目录",
                xtype:'displayfield',
                value:'/usr/sbin/nod32'
            },{
                xtype:'hidden',
                name:'channelIChangeUtils.virusscan',
                value:'/usr/sbin/nod32'
            },{
                fieldLabel:"备份数据开始覆盖容量阀值(%)",
                xtype:'displayfield',
                id:'backupdirdelete.info'
            },{
                fieldLabel:'滑动设置',
                id:'backupdirdelete.slider.info',
                xtype:'slider',
                increment:1,
                minValue:30,
                maxValue:80,
                plugins: new Ext.slider.Tip({
                    getText: function(thumb){
                        Ext.getCmp('backupdirdelete.info').setValue(thumb.value);
                        Ext.getCmp('backupdirdelete.hidden.info').setValue(thumb.value);
                        return String.format('<b>{0}% 开始覆盖</b>', thumb.value);
                    }
                })
            },{
                id:'backupdirdelete.hidden.info',
                xtype:'hidden',
                name:'channelIChangeUtils.backupdirdelete'
            },{
                fieldLabel:"系统重启策略",
                id:'restarttime.info',
...
//        var systemmeantime = store.getAt(0).get('systemmeantime');
        var backupdirdelete  = store.getAt(0).get('backupdirdelete');
        ...
        Ext.getCmp('backupdirdelete.info').setValue(backupdirdelete);
        Ext.getCmp('backupdirdelete.hidden.info').setValue(backupdirdelete);
        Ext.getCmp('backupdirdelete.slider.info').setValue(backupdirdelete);

...
Ext.onReady(function(){
    ...
    var panel3 = new Ext.Panel({
        ...
        items:[{
            ...
            items:[{
                fieldLabel:'测试',
                xtype:'displayfield',
                value:'<a href="javascript:;" onclick="arp_a();" style="color: green;">测试</a>'
            },{
                id:'result.area.info',
                width:450,
                fieldLabel:'显示结果',
    ...
    new Ext.Viewport({
        ...
        items:[{
            ...
            items:[{layout:'column',plain:true,autoScroll:true,items:[panel]},panel2,panel3]
        }]
    });
    store.load();
...
function arp_a(){
    ...
    Ext.Ajax.request({
        ...
        success:function(response,option){
            ...
            Ext.getCmp('result.area.info').setValue(result);
        }
    });

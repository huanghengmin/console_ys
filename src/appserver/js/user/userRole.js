...
Ext.onReady(function() {
    ...
    var proxy = new Ext.data.HttpProxy({
        url:"../../RoleAction_select.action?accountType=2"
    });
...
var storeType = new Ext.data.Store({
    url:"../../RoleAction_readTypeKeyValue.action?accountType=2",
    reader:readerType
});
...
function roleInsert(formPanel,grid,store,win,ids){
    if (formPanel.form.isValid()) {
        formPanel.getForm().submit({
            url :'../../RoleAction_insert.action?accountType=2',
            method :'POST',
            params:{pIds:ids},
            waitTitle :'系统提示',
            waitMsg :'正在保存,请稍后...',
...
function roleUpdate(formPanel,grid,store,win,ids){
    if (formPanel.form.isValid()) {
        formPanel.getForm().submit({
            url :'../../RoleAction_update.action?accountType=2',
            method :'POST',
            params:{pIds:ids},
            waitTitle :'系统提示',
            waitMsg :'正在修改,请稍后...',

	...
	function showURL_flag(value){
		if(value == 'Ethernet_isUp'){
			return "<a href='javascript:;' onclick='detail_win();' style='color: green;'>详细</a>&nbsp;&nbsp;&nbsp;&nbsp;" +
                "<a href='javascript:;' onclick='insert_win();' style='color: green;'>新增虚拟网口</a>&nbsp;&nbsp;&nbsp;&nbsp;" +
                "<a href='javascript:;' onclick='update_win();' style='color: green;'>修改</a>&nbsp;&nbsp;&nbsp;&nbsp;注销";
		}else if(value == 'Ethernet(虚拟)_isUp'){
			return "<a href='javascript:;' onclick='detail_win();' style='color: green;'>详细</a>&nbsp;&nbsp;&nbsp;&nbsp;" +
                "<a id='btnRemove.interface.info' href='javascript:;' onclick='delete_row();' style='color: green;'>删除虚拟网口</a>&nbsp;&nbsp;&nbsp;&nbsp;" +
...
function ifUp(){
    ...
    if(selModel.hasSelection()){
        ...
        Ext.each(selections,function(item){
        	...
        	Ext.MessageBox.show({
            	title:'信息',
            	msg:'<font color="green">确定要激活所选网络网口？</font>',
...
function ifDown(){
    ...
    if(selModel.hasSelection()){
        ...
        Ext.each(selections,function(item){
        	...
        	Ext.MessageBox.show({
            	title:'信息',
            	msg:'<font color="green">确定要注销所选网络网口？</font>',
//            	animEl:'ifUp.interface.info',
            	width:200,

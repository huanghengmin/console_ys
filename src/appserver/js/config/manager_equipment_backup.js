...
//            fieldLabel:'主设备服务状态',
        	...
        	fieldLabel:"Ping策略",
        	id:'restarttime.info',
        	html:"<a href='javascript:;' onclick='ping_win();'style='color: green;'>管理</a>",
        	xtype:'displayfield'
        },{
        	fieldLabel:"Telnet策略",
        	html:"<a href='javascript:;' onclick='telnet_win();' style='color: green;'>管理</a>",
        	xtype:'displayfield'
        },{
        	fieldLabel:"文件共享策略",
        	html:"<a href='javascript:;' onclick='other_win();'style='color: green;'>管理</a>",
        	xtype:'displayfield'
        }]
    });
...
function show_status(value){
    if(value == '1' || value == 1) {
//        return "<h1 style='color: green;'>热备正常</h1>";
...
function show_url_ping(value) {
    if(value==2){
        return "<a href='javascript:;' onclick='updatePingWin()' style='color: green;'>修改信息</a>";
   }
}
...
function show_url_telnet(value) {
    if(value==2){
        return "<a href='javascript:;' onclick='updateTelnetWin()' style='color: green;'>修改信息</a>";
   }
}
...
function show_url_other(value) {
    if(value==2){
        return "<a href='javascript:;' onclick='updateOtherWin()' style='color: green;'>修改信息</a>";
   }
}
